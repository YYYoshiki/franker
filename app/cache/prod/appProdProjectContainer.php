...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app/cache/prod/assetic/config'), false)));
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        return $instance;
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app/Resources');
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'franker', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = $this->get('annotation_reader');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_e157786f2b69c850d2d918263d3d4c5ae34216a8d93bcc581fa5d6a6da6d17e3');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_e157786f2b69c850d2d918263d3d4c5ae34216a8d93bcc581fa5d6a6da6d17e3');
        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_e157786f2b69c850d2d918263d3d4c5ae34216a8d93bcc581fa5d6a6da6d17e3');
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => 'C:\\Users\\Yoshiki\\Desktop\\eclipse\\workspace\\franker\\src\\Test\\HelloBundle\\Entity', 1 => 'C:\\Users\\Yoshiki\\Desktop\\eclipse\\workspace\\franker\\src\\Chat\\ChatBundle\\Entity'));
        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Test\\HelloBundle\\Entity');
        $f->addDriver($e, 'Chat\\ChatBundle\\Entity');
        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('TestHelloBundle' => 'Test\\HelloBundle\\Entity', 'ChatChatBundle' => 'Chat\\ChatBundle\\Entity'));
        $g->setMetadataCacheImpl($b);
        $g->setQueryCacheImpl($c);
        $g->setResultCacheImpl($d);
        $g->setMetadataDriverImpl($f);
        $g->setProxyDir('C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app/logs/prod.log', 100, true);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $g = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $d, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($d, '/menu'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'secured_area', $b, $c), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy'), $d, 'secured_area', $h, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $b), array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($a, $f, 'secured_area', $i, $b), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '54bf2bf1eab36', $b), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'secured_area', $i, NULL, NULL, $b));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app', 'UTF-8');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\Users\\Yoshiki\\Desktop\\eclipse\\workspace\\franker\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\Users\\Yoshiki\\Desktop\\eclipse\\workspace\\franker\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\Users\\Yoshiki\\Desktop\\eclipse\\workspace\\franker\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\Users\\Yoshiki\\Desktop\\eclipse\\workspace\\franker\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\Users\\Yoshiki\\Desktop\\eclipse\\workspace\\franker\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\Users\\Yoshiki\\Desktop\\eclipse\\workspace\\franker\\src\\Test\\HelloBundle/Resources/views', 'TestHello');
        $instance->addPath('C:\\Users\\Yoshiki\\Desktop\\eclipse\\workspace\\franker\\src\\Chat\\ChatBundle/Resources/views', 'ChatChat');
        $instance->addPath('C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app/Resources/views');
        $instance->addPath('C:\\Users\\Yoshiki\\Desktop\\eclipse\\workspace\\franker\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
        return $instance;
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'C:\\Users\\Yoshiki\\Desktop\\eclipse\\workspace\\franker\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app/cache/prod');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app',
            'kernel.environment' => 'prod',
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app/cache/prod',
            'kernel.logs_dir' => 'C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app/logs',
            ...
            'session.save_path' => 'C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app/cache/prod/sessions',
            ...
            'router.resource' => 'C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app/cache/prod/assetic',
            ...
            'assetic.read_from' => 'C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app/../web',
            'assetic.write_to' => 'C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/Users/Yoshiki/Desktop/eclipse/workspace/franker/app/cache/prod/doctrine/orm/Proxies',
